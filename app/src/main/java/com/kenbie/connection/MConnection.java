...
import com.kenbie.R;
import com.kenbie.SplashActivity;
...
public class MConnection {
    ...
    // GET full url connection
    public void getFullUrlRequestWithHttpHeaders(final Context context, final String url, final APIResponseHandler mListeners, final int APICode) {
...
/*                                JSONObject jResponse = new JSONObject(response);
    ...
    // POST connection
    public void postFullRequestWithHttpHeaders(final Context context, final String url, final APIResponseHandler mListeners, final Map<String, String> params, final int APICode) {
        SharedPreferences mPref = context.getSharedPreferences("kPrefs", MODE_PRIVATE);
        Log.d("Request", url + "::::::::" + params.toString());
        RequestQueue queue = Volley.newRequestQueue(context);
        StringRequest postRequest = new StringRequest(Request.Method.POST, API_BASE_URL + url,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        // response
