...
public class InfoSingleChoiceAdapter extends BaseAdapter {
    private ArrayList<Option> mData;
    private LayoutInflater mLayoutInflater;
    private int selPos = -1;

    public InfoSingleChoiceAdapter(LayoutInflater mLayoutInflater, ArrayList<Option> optionArrayList, int selPos) {
