...
public class MsgConvAdapter extends BaseAdapter implements Filterable {
    ...
    public void refreshPositionData(ArrayList<Message> mData, int position) {
        msgData = mData;
        if (msgData == null)
            msgData = new ArrayList<>();
    }
...
/*  --OLD logic
   ...
   if (convertView == null)
            convertView = mLayoutInflater.inflate(R.layout.msg_conv_cell_view, null);
        else ;

//
//        ImageView userImg = (ImageView) convertView.findViewById(R.id.u_img);
//        Glide.with(mContext).load(Constants.BASE_IMAGE_URL + mUserList.get(position).getUser_img()).apply(RequestOptions.circleCropTransform()).into(userImg);

        LinearLayout leftItem = (LinearLayout) convertView.findViewById(R.id.left_item);
        LinearLayout rightItem = (LinearLayout) convertView.findViewById(R.id.right_item);

        LinearLayout lFile = (LinearLayout) convertView.findViewById(R.id.l_file);
        RelativeLayout rFile = (RelativeLayout) convertView.findViewById(R.id.r_file);
        ProgressBar rImgProgress = (ProgressBar) convertView.findViewById(R.id.r_img_progress);

        ImageView lFileImg = (ImageView) convertView.findViewById(R.id.l_file_icon);
        ImageView rFileImg = (ImageView) convertView.findViewById(R.id.r_file_icon);

        TextView lMsg = (TextView) convertView.findViewById(R.id.l_msg);
        lMsg.setTypeface(KenbieApplication.S_NORMAL);

        TextView rMsg = (TextView) convertView.findViewById(R.id.r_msg);
        rMsg.setTypeface(KenbieApplication.S_NORMAL);

        TextView rMsgStatus = (TextView) convertView.findViewById(R.id.r_msg_status);
        rMsgStatus.setTypeface(KenbieApplication.S_NORMAL);

        TextView lMsgTime = (TextView) convertView.findViewById(R.id.l_msg_time);
        lMsgTime.setTypeface(KenbieApplication.S_NORMAL);

        TextView rMsgTime = (TextView) convertView.findViewById(R.id.r_msg_time);
        rMsgTime.setTypeface(KenbieApplication.S_NORMAL);*/
...
//            holder.rMsgTime.setText(convertTimeWithTimeZone(msgData.get(position).getMsg_time()));
            holder.rMsgTime.setText(msgData.get(position).getMsg_time());
...
//            holder.lMsgTime.setText(convertTimeWithTimeZone(msgData.get(position).getMsg_time()));
            holder.lMsgTime.setText(msgData.get(position).getMsg_time());
            if (msgData.get(position).getAttachment() != null) {
...
/*
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private RelativeLayout rFile;
        private ProgressBar rImgProgress;
        private ImageView lFileImg, rFileImg;
        private TextView lMsg, rMsg, rMsgStatus, lMsgTime, rMsgTime;

        public ViewHolder(View convertView) {
            super(convertView);

            leftItem = (LinearLayout) convertView.findViewById(R.id.left_item);
            rightItem = (LinearLayout) convertView.findViewById(R.id.right_item);

            lFile = (LinearLayout) convertView.findViewById(R.id.l_file);
            rFile = (RelativeLayout) convertView.findViewById(R.id.r_file);
            rImgProgress = (ProgressBar) convertView.findViewById(R.id.r_img_progress);

            lFileImg = (ImageView) convertView.findViewById(R.id.l_file_icon);
            rFileImg = (ImageView) convertView.findViewById(R.id.r_file_icon);
            lMsg = (TextView) convertView.findViewById(R.id.l_msg);
            rMsg = (TextView) convertView.findViewById(R.id.r_msg);
            rMsgStatus = (TextView) convertView.findViewById(R.id.r_msg_status);
            lMsgTime = (TextView) convertView.findViewById(R.id.l_msg_time);
            rMsgTime = (TextView) convertView.findViewById(R.id.r_msg_time);
            lMsg.setTypeface(KenbieApplication.S_NORMAL);
            rMsg.setTypeface(KenbieApplication.S_NORMAL);
            rMsgStatus.setTypeface(KenbieApplication.S_NORMAL);
            lMsgTime.setTypeface(KenbieApplication.S_NORMAL);
...
////                        locationItemArrayList = new DownloadCountry().execute(term).get();
//                        locationItemArrayList = new LocationSync().execute(term).get();
//                    } catch (Exception e) {
//                        Log.d("HUS", "EXCEPTION " + e);
//                    }
//                    filterResults.values = locationItemArrayList;
//                    filterResults.count = locationItemArrayList.size();
//                }
